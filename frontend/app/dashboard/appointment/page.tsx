...
export default async function AppointmentsPage() {
  ...
  return (
    <main className="flex min-h-screen justify-center items-center ">
      ...
      {appointment ? (
        <div className="border-none p-25 space-y-4 rounded-2xl shadow-2xl bg-gradient-to-r from-purple-300 to-purple-50">
          <h1 className='text-center text-4xl  bg-clip-text text-transparent bg-gradient-to-r from-purple-900  to-pink-700 mb-10'>Your Appointment</h1>
          <p className='text-2xl font-serif'><strong>Patient Name:</strong> {appointment.patientName}</p>
